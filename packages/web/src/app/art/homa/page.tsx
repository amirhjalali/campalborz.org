        ...
        <div className="section-contained">
          <Reveal>
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-eyebrow mb-8" style={{ color: 'var(--color-gold-muted)' }}>
                THE MYTHOLOGY
              </p>
        ...
        <div className="section-contained">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Reveal delay={0.15} direction="right">
              <div className="image-frame image-grain image-hover-zoom relative aspect-[3/4] md:aspect-auto md:h-full">
                <Image
