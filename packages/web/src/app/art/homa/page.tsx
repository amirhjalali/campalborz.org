...
import { ArrowLeft, ArrowRight, MapPin, Calendar, Volume2, Zap } from 'lucide-react';
          ...
          <div className="section-contained">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-2xl">
              {[
                ...
                >
                  <div className="flex-shrink-0 p-3 rounded-full bg-gold-500/15 border border-gold-500/25">
          ...
          <div className="section-contained">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="blockquote-elegant">
                <p className="font-accent text-xl md:text-2xl italic text-tan-light/90 leading-relaxed">
        ...
        <section className="section-base">
          <div className="section-contained">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 image-frame image-grain relative aspect-[16/10] group">
                <Image
                  src="/images/migrated/homa/149889f001e2f7945fa917258838a272.jpg"
              ...
              <div className="image-frame image-grain relative aspect-[3/4] md:aspect-auto group">
                <Image
