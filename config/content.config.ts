...
export const contentConfig: ContentConfig = {
  ...
  // Stats - Camp Alborz impact numbers
  stats: [
    {
      label: "Years on the Playa",
      value: "15+",
      icon: "flame",
      description: "Building community since 2008",
    ...
    },
    {
      ...
      value: "500+",
      icon: "users",
      description: "Global community across LA, Brooklyn, and Tehran",
      color: "from-desert-gold to-saffron",
    },
    {
      label: "Raised for Art & Culture",
      value: "$50K+",
      icon: "heart",
      description: "100% goes to art cars, installations, and events",
    ...
    },
    {
      ...
      value: "20+",
      icon: "calendar",
      description: "Fundraisers, workshops, and gatherings",
    ...
    },
    {
      ...
      value: "2",
      icon: "sparkles",
      description: "HOMA and DAMAVAND mobile art platforms",
